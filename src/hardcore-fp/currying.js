...
const words = r.split(' ')
a.assertArraysAreEqual(['one', 'two', 'three'], words('one two three'))
...
a.assertArraysAreEqual([3, 6, 9], tripleList([1, 2, 3]))
...
a.assertEqual(9, max([1, -348, 9, 7, 2]))
a.assertEqual(-1, max([-12, -3483, -2, -1]))
